...
EXPORT_SYMBOL_GPL(__memcg_kmem_uncharge_page);
...
EXPORT_SYMBOL_GPL(split_page_memcg);
...
EXPORT_SYMBOL_GPL(mem_cgroup_wb_domain);
...
EXPORT_SYMBOL_GPL(mem_cgroup_wb_stats);
...
EXPORT_SYMBOL_GPL(mem_cgroup_flush_foreign);
