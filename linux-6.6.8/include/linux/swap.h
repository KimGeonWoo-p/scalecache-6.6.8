...
extern unsigned long cc_try_to_free_pages(struct zonelist *zonelist, int order,
					gfp_t gfp_mask, nodemask_t *mask);
...
extern long remove_mapping(struct address_space *mapping, struct folio *folio);
extern long cc_remove_mapping(struct address_space *mapping, struct folio *folio);
